...
export class BaseAgent {
  ...
  public constructor({
    ...
    // Use custom endpoints if provided, otherwise default to localhost
    const agentEndpoints = endpoints || [`http://localhost:${this.port}`];
    ...
    this.agent.modules.didcomm.registerInboundTransport(
      new HttpInboundTransport({ port })
    );
    this.agent.modules.didcomm.registerOutboundTransport(
